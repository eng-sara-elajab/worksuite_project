                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="notes" id="notes" rows="5" class="form-control">{{ $project->notes }}</textarea>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="feedback" id="feedback" rows="5" class="form-control">{{ $project->feedback }}</textarea>
                                </div>
                            </div>
