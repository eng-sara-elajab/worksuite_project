                            ...
                            <div class="col-md-12">
                                <div class="white-box">
                                    <h3 class="b-b p-b-10">@lang('app.project') #{{ $project->id }} -
                                        ...
                                        <a href="{{ route('admin.projects.edit', $project->id) }}" class="pull-right btn btn-info btn-outline btn-rounded visible-lg visible-md" style="font-size: small"><i class="icon-note"></i> @lang('app.edit')</a>
                                        
                                        <a href="{{ route('admin.projects.edit', $project->id) }}" class="visible-xs visible-sm" style="font-size: small"><i class="icon-note"></i> @lang('app.edit')</a>  
                                    ...
                                    <div class="row row-in">
                                                ...
                                                <div class="col-md-12 col-sm-12 col-xs-12">
                                                    <div class="progress">
                                                        <div class="progress-bar progress-bar-danger" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"
                                                            style="width: {{ $openTasksPercent }}%"><span class="sr-only">{{ $openTasksPercent }}% @lang('app.complete') (success)</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-3 col-sm-6 row-in-br  b-r-none">
                                            <div class="col-in row">
                                                ...
                                                <div class="col-md-12 col-sm-12 col-xs-12">
                                                    <div class="progress">
                                                        <div class="progress-bar progress-bar-info" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: {{ $daysLeftPercent }}%"><span class="sr-only">{{ $daysLeftPercent }}% @lang('app.complete') (success)</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-12 col-sm-12 col-xs-12">
                                                    <div class="progress">
                                                        <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"
                                                            style="width: 100%"><span class="sr-only">100% Complete (success)</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-3 col-sm-6  b-0">
                                            <div class="col-in row">
                                                ...
                                                @if ($project->completion_percent
                                                < 50) <?php $statusColor='danger' ; ?>
                                                    @elseif ($project->completion_percent >= 50 && $project->completion_percent
                                                    <
                                                        75) <?php $statusColor='warning' ; ?>
                                                        @else
                                                        <?php $statusColor = 'success'; ?> @endif
                                                        <div class="col-md-6 col-sm-6 col-xs-6">
                                                        ...
                                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                                            ...
                                                            <div class="progress">
                                                                <div class="progress-bar progress-bar-{{ $statusColor }}" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"
                                                                    style="width: {{ $project->completion_percent }}%"><span class="sr-only">{{ $project->completion_percent }}% Complete (success)</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="white-box bg-success p-t-10 p-b-10">
                                    <h3 class="box-title text-white">@lang('app.earnings')
                                            <a class="mytooltip" href="javascript:void(0)"> <i class="fa fa-info-circle text-white"></i><span class="tooltip-content5"><span class="tooltip-text3"><span class="tooltip-inner2">@lang('modules.projects.projectEarningInfo')</span></span></span></a>
                                    </h3>
                                    <ul class="list-inline two-part">
                                        <li><i class="fa fa-money text-white"></i></li>
                                        <li class="text-right"><span id="totalProjects" class="text-white">{{ !is_null($project->currency_id) ? $project->currency->currency_symbol.$earnings : $earnings }}</span></li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="white-box bg-warning p-t-10 p-b-10">
                                    ...
                                    <ul class="list-inline two-part">
                                        <li><i class="fa fa-money text-white"></i></li>
                                        <li class="text-right"><span id="totalExpenses" class="text-white">
                                            ...
                                            <div class="panel-wrapper collapse in">
                                                <div class="panel-body">
                                                    <ul class="list-task list-group" data-role="tasklist">
                                                        ...
                                                        <li class="list-group-item" data-role="task">
                                                            {{ ($key+1) }}. {{ $file->filename }} <a target="_blank" href="{{ asset_url('project-files/'.$project->id.'/'.$file->hashname) }}"
