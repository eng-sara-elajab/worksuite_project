                                                ...
                                                <div class="panel-wrapper collapse in">
                                                    <div class="panel-body">
                                                        <div class="message-center">
                                                            ...
                                                            alt="user" class="img-circle" width="40" height="40">' : '<img src="'.asset('img/default-profile-2.png').'"
                                                    ...
                                                    <div class="panel-body">
                                                        <ul class="list-task list-group" data-role="tasklist">
                                                            @forelse($recentFiles as $key=>$file)
                                                                <li class="list-group-item" data-role="task">
                                                                   {{ ($key+1) }}. {{ $file->filename }} <a target="_blank" href="{{ asset_url('project-files/'.$project->id.'/'.$file->hashname) }}" class="btn btn-info btn-circle"><i class="fa fa-search"></i></a>
                                                                </li>
                                                            @empty
                                                                <li class="list-group-item" data-role="task">
